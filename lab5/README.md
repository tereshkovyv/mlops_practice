...
3. Все данные строятся вокруг однго тренда:$$y = 2.5x_1 - 4x_2 + 1.8x_3 + 12.5$$
...
![img_1.png](img_1.png)
10. Визуализация данных. Созданы графики демострирующие расположение данных. На чистых данных график демонстрирует идеальную линейную зависимость, а на шумных показывает деградацию модели :
![model_performance.png](model_performance.png)