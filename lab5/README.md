...
10. Визуализация данных. На чистых данных график демонстрирует идеальную линейную зависимость. На зашумленных данных график наглядно иллюстрирует высокую погрешность предсказаний и сильный разброс точек, что визуализирует падение качества метрик модели
